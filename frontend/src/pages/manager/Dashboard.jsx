      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Overview of team attendance</p>
          </div>
          <div>
            <input
              type="date"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">Checked In Now</p>
          ...
          <Card>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 mb-1">Avg Daily Hours</p>
                <p className="text-2xl font-bold text-purple-600">
                  {(summary.average_daily_hours || 0).toFixed(1)}h
                </p>
              </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {employee.status === 'checked_in' && employee.current_session && (
                          <p className="text-xs text-gray-500 mt-1">
                            Since {formatTime(employee.current_session.check_in)}
                          </p>
                        )}
